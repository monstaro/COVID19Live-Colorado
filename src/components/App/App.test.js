...
describe('App', () => {
  beforeEach(() => {
    ...
    var mockCounties = [
      ...
      "Data_Source": "Colorado Department of Public Health and Environment - Number of Positive COVID-19 Cases by County",
  ...
  it('should render what we expect', () => {
    ...
    expect(getByText('A COVID-19 resource for at-risk Colorado residents.')).toBeInTheDocument()
    expect(getByText('Welcome to CovidLive Colorado')).toBeInTheDocument()
    expect(getByText('Our mission is to bring at-risk residents of Colorado the most up-to-date information for their county.')).toBeInTheDocument()
  })
